 ...
 * e recursos avançados de filtros. Requer PHP 6 ou superior.
 *
 * @author     Wagner Lemos <wagnerlemosce@gmail.com>
 * @version    3.8 $ 2018-04-21 14:11:48 $
 */
class canvas
{
    /**
    ...
    private function dimensoes()
    {
         ...
         * https://br2.php.net/manual/en/function.exif-imagetype.php
         **/
    ...
    private function criaImagem()
    {
        switch ($this->formato) {
            ...
            case 3:
                ...
                break;
            case 6:
                $this->img      = createfrombmp($this->origem);
                $this->extensao = 'bmp';
                break;
			case 7:
    ...
    private function preencheImagem()
    {
		...
		if(strtolower($pathinfo['extension']) == 'png') {
			imagecolortransparent($this->img_temp, $cor_fundo);
		}
    ...
    private function redimensionaPreenchimento()
    {
         ...
         * Calculo corrigido por Gilton Guma <https://www.gsguma.com.br/>
         */
     ...
     * Modo proporcional adicionado por Fernando VR ( https://goo.gl/iDtmP )
     * @return void
     **/
     ...
     * https://www.findmotive.com/2006/12/13/php-crop-image/
     ...
     * baseado no script original de Noah Winecoff
     * https://www.php.net/manual/en/ref.image.php#62029
     ...
     *            Ver: https://br2.php.net/imagestring
        ...
        if ($imagem) {
            ...
            switch (strtolower($pathinfo['extension'])) {
                ...
                case 'gif':
                    ...
                    break;
                case 'bmp':
                    $marcadagua = createfrombmp($imagem);
                    break;
				case 'bmp':
